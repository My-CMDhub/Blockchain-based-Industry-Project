 ...
 function showWrongPaymentsList() {
     ...
     const modalHTML = `
         <div class="modal fade" id="wrongPaymentsModal" tabindex="-1" aria-labelledby="wrongPaymentsModalLabel" aria-hidden="true">
             <div class="modal-dialog modal-lg">
                 <div class="modal-content">
                         ...
                         <div class="table-responsive mb-4">
                             <table class="table table-striped table-bordered">
                                 ...
                                 <tbody id="wrongPaymentsTableBody">
                                     <tr>
                                         <td colspan="5" class="text-center">Loading wrong payments...</td>
                                     </tr>
                                 </tbody>
                             </table>
                         </div>
     ...
     // Load wrong payments
     fetchWrongPayments().then(() => {
         // Show the modal
         wrongPaymentsModal.show();
     }).catch(error => {
         console.error('Error loading wrong payments:', error);
         showToast('Failed to load wrong payments. Please try again.', 'error');
     });
 }
 ...
 function displayWrongPayments(data) {
     ...
     if (!data.wrongPayments || data.wrongPayments.length === 0) {
         tableBody.innerHTML = '<tr><td colspan="5" class="text-center">No wrong payments found</td></tr>';
         return;
     }
     ...
     if (rows.length > 0) {
         ...
         tableBody.innerHTML = '<tr><td colspan="5" class="text-center">No wrong payments data available</td></tr>';
     }
 }
